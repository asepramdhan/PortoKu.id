...
new class extends Component {
  ...
  #[Url(as: 'q')] // Membuat pencarian muncul di URL
      ...
      <div class="container mx-auto px-6">
        ...
        <div class="mb-12 max-w-lg mx-auto">
          <div class="relative">
            ...
            <input type="search" wire:model.live.debounce.300ms="search" placeholder="Cari artikel berdasarkan judul..." class="form-input w-full pl-10 !py-3">
          </div>
        </div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          ...
          <div class="blog-card flex flex-col">
            <a href="/blog/show/{{ $post->slug }}" wire:navigate class="block">
              <img src="{{ $post->featured_image_path ?? 'https://placehold.co/600x400/1E293B/FFFFFF?text=PortoKu.id' }}" alt="Gambar thumbnail untuk {{ $post->title }}" class="w-full h-48 object-cover">
            </a>
            <div class="p-6 flex flex-col flex-grow">
              ...
              @endif
              <a href="/blog/show/{{ $post->slug }}" wire:navigate class="group">
              ...
              <p class="mt-4 text-xs text-slate-500">{{ $post->published_at->format('d M Y') }}</p>
            </div>
          </div>
          @endforeach
        </div>
