    ...
    <main class="flex-1 p-6 md:p-8">
        ...
        <form x-data @submit.prevent>
            <div class="card p-6 md:p-8">
                ...
                <div class="space-y-6">
                    ...
                    <div>
                        ...
                        <div
                            ...
                            @drop.prevent="dragging = false; @this.upload('featured_image', $event.dataTransfer.files[0])"
                            class="border-2 border-dashed border-slate-600 rounded-lg p-6 text-center transition-colors cursor-pointer"
                            :class="{ 'border-sky-500 bg-slate-800': dragging }"
                        >
                            <div
                                wire:loading.remove
                            ...
                            >
                                @if ($featured_image)
                                    <img
                                        ...
                                        class="mx-auto rounded-lg h-32"
                                    />
                                @elseif ($existing_featured_image)
                                    <img
                                        src="{{ $existing_featured_image }}"
                                        alt="Gambar Saat Ini"
                                        class="mx-auto rounded-lg h-32"
                                    />
                                @else
                                    ...
                                    >
                                        ...
                                        <label
                                            for="featured_image"
                                            class="mt-2 text-xs text-sky-400 hover:underline cursor-pointer"
                                        >
                    ...
                    <div>
                        ...
                        <input
                            ...
                            wire:model="tags"
                            class="form-input"
                            placeholder="bitcoin, investasi, keuangan"
                        />
                    </div>
                    ...
                    <div>
                        ...
                        <input
                            ...
                            class="form-input text-slate-400 @error("published_at") input-error @enderror"
                        />
                        <p class="mt-2 text-xs text-slate-500">
                            Kosongkan jika ingin disimpan sebagai draf.
                        </p>
                        @error("published_at")
                            <p class="mt-2 text-sm text-red-500">
                                {{ $message }}
                ...
                <div
                    class="pt-6 mt-6 border-t border-slate-800 flex justify-end"
                >
                    <button
                        type="button"
                        @click="$dispatch('trix-submit')"
