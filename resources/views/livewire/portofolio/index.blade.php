        ...
        <form wire:submit.prevent="addTransaction" class="space-y-4">
          ...
          <div class="grid grid-cols-1 gap-4 md:grid-cols-2">
            <div>
              ...
              <input type="text" inputmode="decimal" step="any" id="quantity" x-mask:dynamic="'9.99999999'" wire:model="quantity" placeholder="Contoh: 0.05 atau 1.12345" class="form-input @error('quantity') input-error @enderror">
              @error('quantity')
              <p class="mt-2 text-sm text-red-500">{{ $message }}</p>
              @enderror
            </div>
      ...
      <div class="p-6 md:p-8">
        ...
        <form wire:submit.prevent="updateTransaction" class="space-y-4">
          ...
          <div class="grid grid-cols-1 gap-4 md:grid-cols-2">
            <div>
              <label for="quantity" class="mb-2 block text-sm font-medium text-slate-300">Jumlah</label>
              <input type="text" inputmode="decimal" step="any" id="quantity" x-mask:dynamic="'9.99999999'" wire:model="quantity" placeholder="Contoh: 0.05 atau 1.12345" class="form-input">
            </div>
            <div>
              <label for="price" class="mb-2 block text-sm font-medium text-slate-300">Harga per Koin (IDR)</label>
